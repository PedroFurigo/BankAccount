/**
 * The package "edu.funtec.banco.conta.usuario" contains the class "NewUser".
 */
package edu.funtec.banco.conta.usuario;

/**
 * The class "NewUser" represents a bank user.
 */
public class NewUser {
    ...
    /**
     * Constructor for the "NewUser" class.
     *
     ...
     */
    public NewUser(String accountHolderName, int accountNumber, String agency, double balance, String openingDate) {
        super();
    ...
    /**
     * Returns a string representation of the "NewUser" object.
     *
     * @return String representation of the "NewUser" object
     */
    @Override
